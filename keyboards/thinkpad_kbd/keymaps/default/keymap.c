...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT(
        ...
        MO(_OPTS), KC_LCTL,   KC_LGUI, KC_LALT, KC_SPC,                                      OSL(_ALT_GR), KC_PSCR, KC_RCTL, KC_PGUP,KC_UP,  KC_PGDN,
    ...
    [_ALT_GR] = LAYOUT(
        ...
        _______,      _______,    _______,    OSL(_EMOJI),    _______,    _______,    _______,    _______,    _______,    _______,    _______,    OSL(_lUML), _______,   _______,
